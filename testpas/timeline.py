...
def get_study_day(start_date, now=None, compressed=False, seconds_per_day=86400, reference_timestamp=None):
    """
    ...
    reference_timestamp: specific timestamp to use as reference for time compression
    """
    if not start_date:
        return 0
    now = now or tz_now()
