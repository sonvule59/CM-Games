...
const PHRASES = [
  {
    ...
    delta: { mood: 6, mobility: 4, confidence: 4, energy: 2 },
  },
  {
    id: 'small-steps',
  ...
  },
  {
    ...
    delta: { mood: 7, mobility: 3, energy: 4 },
  },
  {
    id: 'body-kindness',
    ...
    delta: { mobility: 6, mood: 5, confidence: 5 },
  },
  {
    id: 'calmer-moving',
    ...
    delta: { mood: 8, energy: 4, mobility: 3 },
  },
  {
    id: 'grateful',
    ...
    delta: { confidence: 7, mood: 5, mobility: 2 },
  },
  {
    id: 'showing-up',
  ...
  },
  {
    ...
    delta: { energy: 6, mood: 5, mobility: 4 },
  },
  {
    id: 'relaxed-stretch',
    ...
    delta: { mobility: 7, mood: 6, energy: 3 },
  },
  {
    id: 'self-care',
    ...
    delta: { mood: 7, confidence: 4, mobility: 3 },
  },
  {
    id: 'warmth',
    ...
    delta: { mobility: 5, mood: 5, confidence: 3 },
  },
  {
    id: 'breathing',
    ...
    delta: { mood: 8, energy: 2, mobility: 3 },
  },
  {
    id: 'light-free',
    ...
    delta: { mobility: 6, mood: 6, confidence: 4 },
  },
  {
    id: 'energy-flows',
    ...
    delta: { energy: 8, mood: 4, mobility: 3 },
  },
  {
    id: 'heart-strength',
      ...
      <div className={rcStyles.header}>
        <div className={rcStyles.headerLeft}>
          ...
          <p className={rcStyles.headerSubtitle}>
            Tap any line that fits you right now. Your stats shift a little to reflect the mood of each choice.
          </p>
          <div className={rcStyles.scenePill}>Gentle practice</div>
        </div>
        <div className="flex flex-wrap items-center gap-2 justify-end">
          <button type="button" className={rcStyles.secondaryButton} onClick={() => navigate('/mindfulness-home')}>
            Back
          </button>
          <button type="button" className={rcStyles.resetButton} onClick={reset}>
            Reset
          </button>
        </div>
      </div>
